   ...
   '@tags': ['HappyPath'],
    'HappyPath': function(client) {
     ...
     client
       ...
       .waitForElementPresent(`div > :nth-child(4) .qa-ProviderRow-Check-providerStatus`,120000)
       .waitForElementPresent(`div > :nth-child(5) .qa-ProviderRow-Check-providerStatus`,120000)
