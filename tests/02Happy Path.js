   ...
   '@tags': ['HappyPath'],
    'HappyPath': function(client) {
     ...
     client
       ...
       .changeInput(`[name=password]`, `CSS`, client.globals.GeoAxisUser, `Change input to... "client.globals.GeoAxisPass"`)
       .click(`[name=username]`, `CSS`, `Click element`)
       .changeInput(`[name=username]`, `CSS`, client.globals.GeoAxisPass, `Change input to... "client.globals.GeoAxisUser"`)
