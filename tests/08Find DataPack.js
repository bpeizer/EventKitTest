 ...
 module.exports = {
   '@tags': ['FindDataPack'],
    'FindDataPack': function(client) {
     ...
     client
       .url(client.globals.EventKitBase, 500, 500, `Load page... "EventKitBase"`)
       .maximizeWindow()
       ...
       .click(`.qa-DataPackSearchBar-TextField > input`,`CSS`,`click element`)
       .changeInput(`.qa-DataPackSearchBar-TextField > input`, `CSS`, `Selenium Test`, `Change input to... "Selenium Test"`)
       .elTextIs(`div > div > div:nth-of-type(1) > div > div > div > span > div > div > div > a`, `CSS`, `Selenium Test`, `El text is... "Selenium Test"`)
       .click(`div > div > div:nth-of-type(1) > div > div > div > span > div > div > div > a`, `CSS`, `Click element`)
