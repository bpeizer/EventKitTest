 ...
 module.exports = {
   '@tags': ['HappyPath DigitalGlobe Imagery'],
    'HappyPath DigitalGlobe Imagery': function(client) {
     ...
     client
       ...
       .waitForElementPresent(`div > :nth-child(4) .qa-ProviderRow-Check-providerStatus`,240000)
       .waitForElementPresent(`div > :nth-child(5) .qa-ProviderRow-Check-providerStatus`,240000)
       ...
       .elementPresent(`div > :nth-child(5) .qa-ProviderRow-Check-providerStatus`, `CSS`, `El is present`)
