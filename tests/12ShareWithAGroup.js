...
module.exports = {
    ...
    'Share With A Group': function(client) {
        ...
        client
            ...
            .createDatapack(client,'Broadlands','1','DigitalGlobe Imagery (Foundation GEOINT)','Keep')
            .toggleSharingDatapack(client,'DigitalGlobe Imagery (Foundation GEOINT) Happy Path Test Export Name','Member','Selenium Testing')
            .menuNavigation('Logout')
            .loginStep(client,client.globals.GeoAxisUser2,client.globals.GeoAxisPass)
            .searchForDatapack(client,'DigitalGlobe Imagery (Foundation GEOINT) Happy Path Test Export Name')
            .menuNavigation('Logout')
            .loginStep(client,client.globals.GeoAxisUser,client.globals.GeoAxisPass)
            .menuNavigation(client,'Members and Groups')
            .click(`.qa-UserGroupsPage-RaisedButton-create`,`CSS`,`click create group`)
